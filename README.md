...
* **No Disk Mess (Piping)**: It streams raw frames directly through system memory, keeping your disk clean and avoiding thousands of temporary PNG files.
* **Auto-Downscaling**: it defaults to `800px` width and `15 FPS`. Downscaling first cuts the data stream by **over 80%**, making conversion twice as fast.
